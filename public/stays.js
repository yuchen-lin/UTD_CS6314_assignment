    ...
    stayForm.addEventListener("submit", async function (event) {
      ...
      try {
        ...
        if (availableHotels.length === 0) {
          displayHotels.innerHTML += "No available hotels in the selected city with those dates and requested number of rooms.";
        } else {
        ...
        errorMessage.textContent = "Failed to fetch available hotels. Please try again.";
      }
    });
  });
